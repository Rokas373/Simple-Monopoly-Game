...
function payTax(player, property) {
...
function updatePropertyDropdown(player) {
...
(_a = document.getElementById('rollButton')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
    movePlayer(currentPlayer);
    switchPlayer();
});
(_b = document.getElementById('buildHouseButton')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
    const propertySelect = document.getElementById('propertySelect');
...
(_c = document.getElementById('restartButton')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', restartGame);
initGame();
